...
import { Lock, Mail, AlertTriangle, ArrowRight, Trophy } from 'lucide-react';
        ...
        <div className="glass rounded-2xl p-8 shadow-2xl border border-slate-800">
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-slate-400">
              ¿No tienes cuenta?{' '}
              <Link href="/registro" className="font-semibold text-teal-400 hover:text-teal-300 transition-colors">
                Regístrate aquí
              </Link>
            </p>
          </div>
